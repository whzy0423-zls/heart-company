...
export const TYPE_THEME = Object.freeze({
  ...
  3: Object.freeze({ accent: '#B56A24', soft: '#F5E7D5', ink: '#704115' }),
  4: Object.freeze({ accent: '#7B5AA6', soft: '#ECE4F4', ink: '#4D376B' }),
  5: Object.freeze({ accent: '#347B62', soft: '#DCECE5', ink: '#20513F' }),
  6: Object.freeze({ accent: '#42658D', soft: '#DEE7F0', ink: '#29425E' }),
  7: Object.freeze({ accent: '#B77D14', soft: '#F6EACB', ink: '#6E4A0C' }),
  8: Object.freeze({ accent: '#9C3E37', soft: '#F1DEDB', ink: '#652621' }),
