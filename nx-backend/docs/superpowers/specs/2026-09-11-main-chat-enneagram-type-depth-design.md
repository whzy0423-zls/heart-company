...
Two or more canonical Chinese type names joined as a short list, such as `完美型和助人型`, form an implicit knowledge request even without an additional intent word.
