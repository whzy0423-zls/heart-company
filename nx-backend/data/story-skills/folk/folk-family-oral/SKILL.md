---
name: folk-family-oral
description: Use when generating a user's “我的故事” in the 家庭口述 style under the folk story type.
---
...
- Candidate sources: 民间故事口述结构、家庭与民俗资料；具体事实只来自用户材料
...
## Style rules
    ...
    - 保留讲述者身份和记忆来源，区分亲历、听闻和后来理解。
- 家风只作为家庭内部经验，不概括为所有家庭都应遵循的规范。
- 长辈观点可以与年轻人的感受并置，不把代际差异写成单向教训。
- 结尾保留一句生活化的余味或问题，不强行总结大道理。
