---
name: folk-local-life
description: Use when generating a user's “我的故事” in the 地方生活 style under the folk story type.
---
...
- Candidate sources: 中国社会民俗史丛书; 少数民族风物与民间故事资料
...
## Style rules
    ...
    - 优先写食物、工具、街巷和劳作等可观察细节，避免凭空添加地方知识。
- 日常困难通过邻里协作、个人选择和实际后果推进。
- 方言只使用用户提供或来源明确的词语，并附上下文让人能理解。
- 不把地方生活浪漫化为没有冲突的田园风景。
