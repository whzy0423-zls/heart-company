---
name: folk-chinese-story
description: Use when generating a user's “我的故事” in the 民间叙事 style under the folk story type.
---
...
- Candidate sources: 中国神话鬼怪合集/少数民族神话; 满族民间故事选; 少数民族风物
...
## Style rules
    ...
    - 使用清晰的讲述者口吻、重复节奏和因果分明的事件链。
- 地方风物只能来自用户材料或已核实来源，不凭空添加方言、习俗和地名解释。
- 人物可以朴素、幽默、有缺点，但不把真实人物写成固定的善恶类型。
- 结尾保留民间故事的余味，可以有一句启示，但不强行上价值。
