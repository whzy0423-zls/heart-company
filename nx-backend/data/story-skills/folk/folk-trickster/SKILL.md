---
name: folk-trickster
description: Use when generating a user's “我的故事” in the 机智民间故事 style under the folk story type.
---
...
- Candidate sources: 民间故事与寓言中的机智人物母题
...
## Style rules
    ...
    - 机智来自观察、沟通和承担后果，不鼓励欺骗、报复或违法行为。
- 笑点针对处境和误会，不针对弱势群体、地域或身份。
- 每次变通都要解决一个具体障碍，不能凭巧合收尾。
- 结尾保留幽默余味，同时承认行动的代价和边界。
