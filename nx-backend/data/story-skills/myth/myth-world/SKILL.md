---
name: myth-world
description: Use when generating a user's “我的故事” in the 跨文化神话母题 style under the myth story type.
---
...
- Candidate sources: 世界各地神话（共12部）; 世界神话大全; 古希腊神话、埃及神话及其他世界神话资料
...
## Style rules
    ...
    - 只选一个主要母题，例如创世、下行、寻找、牺牲或归返，避免神话百科式堆砌。
- 说明这是文学象征，不把不同文化的神话体系混写成同一传统。
- 不使用文化刻板印象，不把某一神话传统定义为唯一真理。
- 真实经历仍是故事的事实骨架，神话只改变叙述视角和意象。
