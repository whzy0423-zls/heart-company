---
name: myth-creation-renewal
description: Use when generating a user's “我的故事” in the 创世重建 style under the myth story type.
---
...
- Candidate sources: 中国神话、世界神话中的创世与重建母题
...
## Style rules
    ...
    - 把创世意象限定为情绪和阶段的隐喻，不宣称用户改变了现实世界。
- 先写旧秩序如何失效，再写可见的小规模重建行动。
- 重建允许不完整、有代价，避免把困难包装成必然的伟大使命。
- 区分不同文化的创世传统，不拼接神谱形成伪传统。
