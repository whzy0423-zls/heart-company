---
name: fairy-fantasy-adventure
description: Use when generating a user's “我的故事” in the 探索与任务 style under the fairy_tale story type.
---
...
- Candidate sources: 01-童话故事类-321本/世界童话精选; 冰雪奇缘、乐高系列及其他幻想故事资料
...
## Style rules
    ...
    - 先把真实经历转换成一个明确任务，再设计不超过三种象征性障碍。
- 世界规则保持简单一致，奇幻设定服务于情绪和选择，不抢走真实经历的主体。
- 每次获得帮助都要对应用户材料中的真实支持或资源。
- 冒险结束后回到现实情感，说明主角获得的理解，而不是只留下奇观。
