---
name: realistic-travel-memory
description: Use when generating a user's “我的故事” in the 旅行纪实 style under the realistic story type.
---
...
- Candidate sources: 后端事实卡、用户确认的旅行材料
...
## Style rules
    ...
    - 地名、路线、人物和时间只使用材料中可确认的信息。
- 把景物描写连接到当时的行动和感受，避免变成景点百科。
- 不把短暂观察概括为对一个地区或群体的普遍判断。
- 保留计划变化和意外，但不制造戏剧化险情。
