---
name: realistic-healing
description: Use when generating a user's “我的故事” in the 恢复过程 style under the realistic story type.
---
...
- Candidate sources: 后端事实卡、用户确认的恢复经历
...
## Style rules
    ...
    - 只记录用户确认的感受、支持和行动，不做诊断或治疗建议。
- 把恢复写成反复、有限和具体的过程，不要求受伤经历必须产生积极意义。
- 涉及当下风险时保持温和求助提示，不描写可模仿的伤害细节。
- 结尾允许停留在尚未完成的阶段，避免强行圆满。
