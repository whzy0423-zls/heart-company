---
name: realistic-family-memory
description: Use when generating a user's “我的故事” in the 家庭经历 style under the realistic story type.
---
...
- Candidate sources: 后端事实卡、用户确认的家庭经历
...
## Style rules
    ...
    - 区分用户亲历、他人转述和自己的解释，不替家人猜测内心动机。
- 冲突写清事件、回应和影响，不给家庭成员贴固定人格标签。
- 隐私信息使用化名或概括称呼，未经确认不添加亲属关系细节。
- reflection 可以写理解和边界，但不把和解写成必然结局。
