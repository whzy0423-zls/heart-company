...
async function save() {
  ...
  try {
    const payload: ModelConfigPayload = {
      ...
      xinzhiliVoice: {
        ...form.value.xinzhiliVoice,
        asr: {
          ...form.value.xinzhiliVoice.asr,
          timeoutSeconds: Number(
            form.value.xinzhiliVoice.asr.timeoutSeconds || 30,
          ),
        },
        tts: {
          ...form.value.xinzhiliVoice.tts,
          speed: Number(form.value.xinzhiliVoice.tts.speed || 1),
          timeoutSeconds: Number(
            form.value.xinzhiliVoice.tts.timeoutSeconds || 45,
          ),
        },
        interaction: {
          ...form.value.xinzhiliVoice.interaction,
          endSilenceMs: Number(
            form.value.xinzhiliVoice.interaction.endSilenceMs || 700,
          ),
          minSpeechMs: Number(
            form.value.xinzhiliVoice.interaction.minSpeechMs || 300,
          ),
          maxTurnSeconds: Number(
            form.value.xinzhiliVoice.interaction.maxTurnSeconds || 60,
          ),
        },
      },
    };
    ...
    form.value.xinzhiliVoice.asr.apiKey = '';
    form.value.xinzhiliVoice.tts.apiKey = '';
    ...
    xinzhiliAsrKeySet.value =
      saved.xinzhiliVoice?.asr.apiKeySet ?? false;
    xinzhiliTtsKeySet.value =
      saved.xinzhiliVoice?.tts.apiKeySet ?? false;
