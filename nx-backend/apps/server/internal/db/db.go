...
var defaultMenus = []seedMenu{
	...
	{ID: 1409, PID: 1408, Name: "MiniappTeacherManagement", Path: "/teachers", Component: "/teacher/index", AuthCode: "Miniapp:Teacher:Manage", Type: "menu", Sort: 1, Icon: "lucide:graduation-cap", Title: "老师资料与审核"},
