...
var defaultMenus = []seedMenu{
	...
	{ID: 1403, PID: 1400, Name: "MiniappClassroomUploads", Path: "/miniapp/classroom/uploads", Component: "/classroom/upload-tasks", AuthCode: "Miniapp:Classroom:Upload", Type: "menu", Sort: 3, Icon: "lucide:cloud-upload", Title: "上传任务"},
	{ID: 1404, PID: 1401, Name: "MiniappClassroomWrite", AuthCode: "Miniapp:Classroom:Write", Type: "button", Sort: 1, Icon: "lucide:pencil", Title: "编辑课件"},
	...
	{ID: 1408, PID: 0, Name: "MiniappTeacher", Path: "/teachers", Type: "catalog", Sort: 14, Icon: "lucide:user-round", Title: "老师管理"},
	...
	{ID: 513, PID: 1300, Name: "MiniappOrders", Path: "/miniapp/orders", Component: "/customer/miniapp-orders", AuthCode: "Customer:MiniappOrders:List", Type: "menu", Sort: 3, Icon: "lucide:receipt-text", Title: "小程序订单"},
	{ID: 514, PID: 1300, Name: "MiniappAnalytics", Path: "/miniapp/analytics", Component: "/customer/miniapp-analytics", AuthCode: "Customer:MiniappOrders:List", Type: "menu", Sort: 4, Icon: "lucide:chart-no-axes-combined", Title: "数据分析"},
	...
	{ID: 1502, PID: 1500, Name: "AppPaymentMode", Path: "/third-party-payment/mode", Component: "/third-party-payment/mode", AuthCode: "System:Payment:Config", Type: "menu", Sort: 2, Icon: "lucide:refresh-cw", Title: "支付模式"},
