...
func TestBuildAppChatEnneagramReplyPlanClassifiesKnowledgeRequests(t *testing.T) {
	tests := []struct {
		...
		{name: "overview introduction", question: "介绍一下九型人格", wantTypes: []int{1, 2, 3, 4, 5, 6, 7, 8, 9}},
		{name: "overview tell me", question: "讲讲九型人格", wantTypes: []int{1, 2, 3, 4, 5, 6, 7, 8, 9}},
		{name: "overview summary", question: "九型人格概述", wantTypes: []int{1, 2, 3, 4, 5, 6, 7, 8, 9}},
		{name: "introduction with explicit number", question: "介绍一下九型人格中的1号", wantTypes: []int{1}},
		{name: "tell me with explicit canonical type", question: "讲讲九型人格的完美型", wantTypes: []int{1}},
		{name: "introduction to wing theory is not overview", question: "介绍九型人格的侧翼理论", wantTypes: nil},
		{name: "single type", question: "1号是什么样的", wantTypes: []int{1}},
		{name: "single chinese type", question: "一号是什么样的", wantTypes: []int{1}},
		...
		{name: "partial list with type marker", question: "九型人格中，1、2、3型分别解释", wantTypes: []int{1, 2, 3}},
		...
		{name: "multi digit is not a type", question: "九型人格10号是什么", wantTypes: nil},
		{name: "multi digit chinese is not a type", question: "九型人格十一号是什么", wantTypes: nil},
		{name: "multi digit chinese range is not types", question: "九型人格十一至四号解释", wantTypes: nil},
		{name: "chinese hundred is not a type", question: "九型人格一百号是什么", wantTypes: nil},
		{name: "chinese thousand is not a type", question: "九型人格一千号是什么", wantTypes: nil},
		{name: "chinese zero is not a type", question: "九型人格零号是什么", wantTypes: nil},
		{name: "chinese circle zero is not a type", question: "九型人格〇号是什么", wantTypes: nil},
		{name: "center count is not a type", question: "九型人格有3个中心吗", wantTypes: nil},
		{name: "centers are not overview", question: "九型人格的三个中心是什么", wantTypes: nil},
		{name: "quiz is not overview", question: "九型人格怎么测试", wantTypes: nil},
		{name: "bare list after anchor is not types", question: "九型人格的三个中心里，1、2、3分别是什么", wantTypes: nil},
