...
func (i batchGenerateInput) options() videoproject.BatchGenerateOptions {
	return videoproject.BatchGenerateOptions{RequestKeys: i.RequestKeys, CapabilityVersions: i.CapabilityVersions}
}
...
func (i generateVideoShotInput) projectInput() videoproject.GenerateShotInput {
	return videoproject.GenerateShotInput{RequestKey: i.RequestKey, CapabilityVersion: i.CapabilityVersion}
}
