...
func TestProtocolErrorPayloadShape(t *testing.T) {
	tests := []struct {
		...
		{"mode snapshot negative revision", `{"code":"x","message":"x","retryable":true,"fatal":false,"modeSnapshot":{"enabledModes":["normal"],"requestedMode":"normal","pendingMode":"normal","effectiveMode":"normal","revision":-1,"configVersion":9}}`, true},
		{"mode snapshot unknown mode", `{"code":"x","message":"x","retryable":true,"fatal":false,"modeSnapshot":{"enabledModes":["normal","mystery"],"requestedMode":"mystery","pendingMode":"normal","effectiveMode":"normal","revision":1,"configVersion":9}}`, true},
		{"mode snapshot missing normal", `{"code":"x","message":"x","retryable":true,"fatal":false,"modeSnapshot":{"enabledModes":["argument"],"requestedMode":"argument","pendingMode":"argument","effectiveMode":"argument","revision":1,"configVersion":9}}`, true},
