            ...
            <div data-canvas-no-zoom onWheelCapture={(event) => event.stopPropagation()}>
                ...
                <div className="mt-5 grid gap-3">
                    <div className="grid gap-2 sm:grid-cols-[56px_minmax(0,1fr)] sm:items-start">
                        <div className="pt-2 text-xs font-medium text-muted-foreground dark:text-muted-foreground">分类</div>
                    ...
                    <div className="grid gap-2 sm:grid-cols-[56px_minmax(0,1fr)] sm:items-start">
                        <div className="pt-2 text-xs font-medium text-muted-foreground dark:text-muted-foreground">标签</div>
                        <div className="flex flex-wrap gap-2">
                            {promptTags.map((tag) => {
