...
export function CanvasProjectCard({ project }: { project: CanvasProject }) {
    ...
    return (
        <article
            className={`group flex min-h-44 cursor-pointer flex-col justify-between rounded-lg border bg-card p-5 shadow-sm transition-colors hover:border-primary/40 hover:bg-accent/50 ${selected ? "border-primary ring-2 ring-primary/10" : "border-border"}`}
        ...
        >
            <div className="flex items-start gap-3">
                <input
                    ...
                    className="mt-1 size-4 accent-primary dark:accent-primary"
